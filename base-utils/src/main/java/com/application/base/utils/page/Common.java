...
public class Common {
	...
	public static boolean isEmpty(String s) {
		String blank="",nullStr="null";
		if (null == s || blank.equals(s) || blank.equals(s.trim())|| s.length()==0 || nullStr.equalsIgnoreCase(s)) {
			return true;
		} else {
			return false;
		}
	...
	private static final Integer OK_NUM = 200;
	...
	public static String getInputHtmlUTF8(String urlStr) {
		...
		try {
			...
			if (httpsURLConnection.getResponseCode() == OK_NUM) {
				// 通过输入流获取网络图片
