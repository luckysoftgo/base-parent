 ...
 * @author 孤狼
 */
public class BaseStringUtil extends org.apache.commons.lang3.StringUtils{
	/** 空字符串 */
	...
	public static String stringValue(Object value) {
		String result = Objects.toString(value, NULLSTR);
		return result.trim();
	}
	...
	public static int intValue(Object value) {
		String valueStr = Objects.toString(NULLSTR.equals(value) ? ZERO : value, ZERO);
	...
	public static boolean isEmpty(Object value) {
		...
		String str1= "null";
		if (NULLSTR.equals(result) || result.length()==0 || str1.equalsIgnoreCase(result)){
			return true;
		}
		return  false;
	}
