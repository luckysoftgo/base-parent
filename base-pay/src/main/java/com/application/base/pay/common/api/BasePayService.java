...
import com.application.base.pay.common.http.HttpRequestTemplate;
...
public abstract class BasePayService implements PayService {
    ...
    protected PayConfig payConfigStorage;
     ...
     */
    @Override
    public BasePayService setPayConfigStorage(PayConfig payConfigStorage) {
        this.payConfigStorage = payConfigStorage;
        return this;
    }

    @Override
    public PayConfig getPayConfigStorage() {
     ...
     */
    @Override
    public BasePayService setRequestTemplateConfigStorage(HttpConfig configStorage) {
        this.requestTemplate = new HttpRequestTemplate(configStorage);
        return this;
    }


    public BasePayService(PayConfig payConfigStorage) {
        this(payConfigStorage, null);
    }

    public BasePayService(PayConfig payConfigStorage, HttpConfig configStorage) {
