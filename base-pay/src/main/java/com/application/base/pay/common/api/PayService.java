...
public interface PayService {
     ...
     * @return 支付服务
     */
    PayService setPayConfigStorage(PayConfig payConfigStorage);
     ...
     * @return  支付服务
     */
    PayService setRequestTemplateConfigStorage(HttpConfig configStorage);
     ...
     * 通用查询接口
     *
     * @param tradeNoOrBillDate 支付平台订单号或者账单日期， 具体请 类型为{@link String }或者 {@link Date }，类型须强制限制，类型不对应则抛出异常{@link }
     *
