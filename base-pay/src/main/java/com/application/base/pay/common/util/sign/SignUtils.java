...
import com.application.base.pay.common.util.sign.encrypt.*;
...
public enum SignUtils {
    ...
    MD5 {
        ...
        public String createSign(String content, String key, String characterEncoding) {
            return Md5Util.sign(content, key, characterEncoding);
        }
        ...
        public boolean verify(String text, String sign, String key, String characterEncoding) {
            return Md5Util.verify(text, sign, key, characterEncoding);
        }
    },
    ...
    RSA {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return RSAUtil.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return RSAUtil.verify(text, sign, publicKey, characterEncoding);
        }
    },
    ...
    RSA2 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return RSA2Util.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return RSA2Util.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA1 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return SHA1Util.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return SHA1Util.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA256 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return Sha256Util.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return Sha256Util.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SM3 {
        @Override
