...
public class AliPayService extends BasePayService {
    ...
    public AliPayService(PayConfig payConfigStorage) {
        super(payConfigStorage);
    }

    public AliPayService(PayConfig payConfigStorage, HttpConfig configStorage) {
    ...
    public boolean verify(Map<String, Object> params) {
        ...
        if (params.get("sign") == null || params.get("notify_id") == null) {
            logger.debug("支付宝支付异常：params：" + params);
            return false;
        }
