...
import com.application.base.pay.common.util.sign.CertDescriptor;
...
public abstract class BasePayConfig implements PayConfig {
     ...
     * 消息来源类型
     */
    private volatile FileType msgType;
    ...
    @Override
    public FileType getMsgType() {
        return msgType;
    }

    public void setMsgType(FileType msgType) {
