...
import com.application.base.pay.common.util.sign.encrypt.Sm3Digest;
...
/**
 * desc acpsdk证书工具类，主要用于对证书的加载和使用
 * @author 孤狼
 */
...
public class SecureUtil {
     ...
     * 日志
     */
    protected static final Logger log = LoggerFactory.getLogger(SecureUtil.class);
    /**
     * 算法常量： SHA1Util
     */
