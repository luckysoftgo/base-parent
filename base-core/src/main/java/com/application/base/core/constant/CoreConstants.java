...
public class CoreConstants extends Constants {
	...
	public static ResultDataVO SYSTEM_SUCCESS = new ResultDataVO(ApiCall.API_CALL_SYS_SUCCESS, "调用服务成功");
	
	@SuppressWarnings("rawtypes")
	public static ResultDataVO SYSTEM_ERROR = new ResultDataVO(ApiCall.API_CALL_SYS_ERROR, "系统内部错误");
	
	@SuppressWarnings("rawtypes")
	public static ResultDataVO INTERFACE_NOT_FOUND = new ResultDataVO(ApiCall.API_CALL_IS_NULL, "调用接口不存在");
