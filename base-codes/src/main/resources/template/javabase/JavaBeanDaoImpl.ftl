...
<#if moreDbTag == "YES">
	@Override
	public synchronized List<${poName}> getObjects(Map<String, Object> param,String factoryTag) throws BusinessException {
		factory.setFactoryTag(factoryTag); //根据实际情况自己添加
		Param params = ParamBuilder.getInstance().getParam().add(param);
		<#if useCache == "YES">
...
<#else>
	@Override
	public List<${poName}> getObjects(Map<String, Object> param) throws BusinessException {
		Param params = ParamBuilder.getInstance().getParam().add(param);
		<#if useCache == "YES">
		return factory.getCacheReadDataSession().queryAllListResult(${poName}.class,params);
		<#else>
...
<#if moreDbTag == "YES">
	@Override
	public synchronized List<${poName}> getObjects(${poName} ${firstLowerPoName},String factoryTag) throws BusinessException {
		factory.setFactoryTag(factoryTag); //根据实际情况自己添加
...
<#else>
	@Override
	public List<${poName}> getObjects(${poName} ${firstLowerPoName}) throws BusinessException {
		Param params = ParamBuilder.getInstance().getParam().add(CommonBeanUtils.transBean2Map(${firstLowerPoName}));
		<#if useCache == "YES">
		return factory.getCacheReadDataSession().queryAllListResult(${poName}.class,params);
		<#else>
