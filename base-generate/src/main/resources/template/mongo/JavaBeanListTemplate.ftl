...
<body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/${lowerName}/find.html" method="post">
	                    ...
	                    <div class="box_bottom pb5 pt5 pr10" style="border-top:0px solid #dadada;">
			              <div class="search_bar_btn" style="text-align:right;">
	                         ...
	                         <sec:authorize ifAnyGranted="ROLE_${SQL.tableName}_addUI">
	                            <input type="button" name="button" class="btn btn82 btn_add" value="新增" onclick="GOTO('<%=request.getContextPath()%>/background/${lowerName}/addUI.html')">
	                         </sec:authorize>
	                         <sec:authorize ifAnyGranted="ROLE_${SQL.tableName}_delete">
