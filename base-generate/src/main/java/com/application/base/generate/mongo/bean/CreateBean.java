package com.application.base.generate.mongo.bean;

import com.application.base.generate.mongo.def.MonGoCodeGoHelper;
...
public class CreateBean {
	...
	private void formatFieldClassType(ColumnData columnt) {
		...
		if (N.equalsIgnoreCase(columnt.getNullable())) {
...
/********************************************************************** 页面的显示***********************************************************************/
	...
	private String getShowPageContent(List<ColumnData> columnDatas) {
		...
		for (int i = 0; i < count; i++) {
			...
			/*2015-09-28
			//时间的设置.
			if (columnData.getColumnType().equalsIgnoreCaseIgnoreCase("Date") || columnData.getColumnType().contains("time")) {
